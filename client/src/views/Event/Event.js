            ...
            <React.Fragment>
                ...
                <div className='Event'>
                    <Helmet>
                        ...
                        <meta property="og:image" content={this.props.EventStore.event.background ? this.props.EventStore.event.background : "https://www.inviteowl.com/owl_382x200_green.png"}/>
                    </Helmet>
                    <Navbar
                        staticColor={true}
